  ...
  <section class="car-menu">
        <div class="container">
         ...
         <?php     
                    ...
                    $sql = "SELECT * FROM tbl_car WHERE active='Yes' LIMIT 4";
        ...
        <?php 
          ...
          if($image_name=="")
             ...
             else
             {
                ...
                ?>
                      <img src="<?php echo SITEURL ; ?>images/car/<?php echo $image_name; ?>" alt=" cars " class="img-responsive img-curve" height="250px">
